...
export const MONGOLS_BUILDERS_DEPOT_CATALOG: CatalogModule = {
  items: [
    ...
    createCatalogItem(
      "hose-bib-1-2in-pvc",
      { JMD: 400 },
      'Pipe Cock/ Hose Bib 1/2" PVC',
    ),
    createCatalogItem(
      "angle-valve-1-2x3-8",
      { JMD: 3348 },
      "Angle Valve 1/2x 3/8",
    ),
    ...
    createCatalogItem(
      "toilet-flush-handle-metal",
      { JMD: 717 },
      "Flush Handle Metal",
    ),
    createCatalogItem(
      "basin-faucet-mixer-single-lever",
      { JMD: 9137 },
      "Mixer Basin Single Lever",
    ),
    createCatalogItem("valve-outlet", { JMD: 1015 }, "Valve Outlet"),

    // Electrical Items
    createCatalogItem(
      "circuit-breaker-20amp-double-pole",
      { JMD: 3105 },
      "Breaker 20Amp DP",
    ),
    createCatalogItem(
      "led-emergency-bulb-11w",
      { JMD: 3105 },
      "Bulb LED Emergency Intelligent 11W",
    ),
    createCatalogItem(
      "electrical-tape-multi-color",
      { JMD: 1050 },
      "Tape Electrical yellow blue red green",
    ),

    // Lumber
    createCatalogItem(
      "lumber-1x3x16-rough-untreated",
      { JMD: 1079 },
      "1x3x16 ROUGH UNTREATED",
    ),
    createCatalogItem(
      "lumber-1x6x16-dress-treated",
      { JMD: 2700 },
      "1x6x16 DRESS TREATED 14/3/25",
    ),
    createCatalogItem("lumber-1x6x14-gt", { JMD: 3770 }, "1x6x14 GT"),
    createCatalogItem(
      "lumber-1x8x16-dress-treated",
      { JMD: 4561 },
      "1x8x16 DRESS TREATED 14/3/25",
    ),
    ...
    createCatalogItem(
      "door-metal-36x80",
      { JMD: 18750 },
      'Door Metal 36" x80" (Raised Panel)',
    ),
    ...
    createCatalogItem(
      "lock-deadbolt-single-key",
      { JMD: 2601 },
      "Lock Deadbolt - Single key",
    ),
    createCatalogItem(
      "lock-entrance-single-turn",
      { JMD: 2790 },
      "Lock Entrance - Single Turn",
    ),
