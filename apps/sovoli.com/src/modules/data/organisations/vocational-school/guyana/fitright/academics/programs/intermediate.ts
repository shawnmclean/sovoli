...
export const FITRIGHT_INTERMEDIATE_SEWING_PROGRAM: Program = {
  ...
  description:
    "This is a 3-week program that teaches students how to sew a blouse. It is designed for students who are new to sewing and want to learn the basics of sewing.",
  courses: [
    {
