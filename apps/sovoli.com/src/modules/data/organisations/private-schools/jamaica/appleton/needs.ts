...
if (!ROOF_SHEET_ITEM) {
  throw new Error("maintenance-zinc-roof-sheet item is missing from core items.");
}

if (!TARPAULIN_ITEM) {
  throw new Error("relief-tarpaulin-heavy-duty item is missing from core items.");
}
...
if (!PORTABLE_GENERATOR_ITEM) {
  throw new Error("equipment-portable-generator item is missing from core items.");
}

export const APPLETON_BASIC_SCHOOL_NEEDS: NeedsModule = {
  needs: [
    {
      id: "absjm-roof-repairs-2025",
      ...
      procurement: {
        ...
        currency: "JMD",
        status: "quoted",
        notes: "Awaiting final quote from local hardware supplier in Santa Cruz.",
      },
      notes:
    ...
    },
    {
      ...
      notes: "Ensure tarpaulins are installed securely to withstand additional rainfall.",
      createdAt: "2025-09-19",
      updatedAt: "2025-09-19",
    },
    {
      id: "absjm-cleanup-kits-2025",
      projectId: "absjm-hurricane-recovery-2025",
      ...
      procurement: {
        ...
        currency: "JMD",
        status: "quoted",
        notes: "Community partner in Black River has offered discounted pricing.",
      },
    ...
    {
      id: "absjm-portable-generator-2025",
      projectId: "absjm-hurricane-recovery-2025",
    ...
    {
      id: "absjm-skilled-volunteers-2025",
      projectId: "absjm-hurricane-recovery-2025",
      ...
      status: "planned",
      procurement: {
        notes: "Coordinate with parish disaster committee to schedule volunteer teams.",
      },
      notes: "Volunteers should have experience with small-scale roof construction.",
      createdAt: "2025-09-16",
      updatedAt: "2025-09-16",
    },
    {
      id: "absjm-debris-removal-crew-2025",
      projectId: "absjm-hurricane-recovery-2025",
      ...
      procurement: {
        ...
        currency: "JMD",
        status: "quoted",
        notes: "Awaiting approval from school board to engage preferred contractor.",
      },
      notes:
