  ...
  highlights: [
    {
      ...
      description: "Assessments run from December 1st through December 10th for all classes.",
    },
    {
      icon: "book-open",
      label: "Curriculum Review",
      description: "Evaluations cover literacy, numeracy, science, and thematic units.",
    },
    {
      icon: "message-circle",
      label: "Teacher Support",
      description: "Teachers provide guidance on study tips and revision plans.",
    },
  ],
  activities: [
    {
      ...
      description: "Daily review blocks to help students prepare for each subject assessment.",
      duration: "45 minutes",
    },
  ],
  requirements: [
    {
      id: "exam-supplies",
      name: "Exam Supplies",
      description: "Bring sharpened pencils, erasers, rulers, and calculators where required.",
      type: "bring",
      isRequired: true,
    },
    {
      id: "rest",
      name: "Rest & Nutrition",
      description: "Ensure students get adequate rest and a healthy breakfast each morning.",
      type: "prepare",
      isRequired: false,
    },
  ],
