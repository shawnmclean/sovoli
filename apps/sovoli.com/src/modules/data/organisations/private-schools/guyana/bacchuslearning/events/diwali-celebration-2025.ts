...
export const DIWALI_CELEBRATION_2025_EVENT: Event = {
  id: "blcgy-diwali-2025",
  slug: "diwali-2025",
  ...
  startTime: "09:00",
  endTime: "15:00",
  location: "Bacchus Learning Centre Main Campus",
  status: "upcoming",
  isPopular: true,
  category: {
  ...
  highlights: [
    ...
    },
    {
      ...
      description: "Creative rangoli designs and traditional art activities",
    },
    {
      icon: "users",
      label: "Class Activities",
      description: "Interactive learning about Diwali traditions and culture",
    },
    {
      icon: "gift",
      label: "Sweet Treats",
  ...
  activities: [
    ...
    },
    {
      ...
      duration: "All day",
      materials: ["Traditional Indian wear (optional)", "Friday casual wear"],
      instructions: [
  ...
  requirements: [
    ...
    },
    {
      id: "sweet-meats",
      name: "Sweet Meats",
      description: "Traditional Indian sweets to share during the celebration",
      type: "bring",
      isRequired: true,
