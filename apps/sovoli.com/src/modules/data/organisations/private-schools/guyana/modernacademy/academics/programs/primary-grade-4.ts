  ...
  requirements: [
    {
      ...
      items: [
        {
          item: findItemById("book-social-studies-for-our-children-book-4")!,
        },
        {
          item: findItemById("book-science-around-us-book-4")!,
        },
        {
          item: findItemById("book-fun-with-language-book-4")!,
        },
        {
