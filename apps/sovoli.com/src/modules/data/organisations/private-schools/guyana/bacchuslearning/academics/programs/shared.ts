...
export const BLCGY_NURSERY_DEPT_ACTIVITIES: Activity[] = [
  {
    id: "mashramani",
    title: "🎭 Mashramani",
  },
...
export const BLCGY_PRIMARY_DEPT_ACTIVITIES: Activity[] = [
  {
    id: "mashramani",
    title: "🎭 Mashramani",
  },
...
export const BLCGY_SECONDARY_DEPT_ACTIVITIES: Activity[] = [
  {
    id: "mashramani",
    title: "🎭 Mashramani",
  },
...
export const secondaryProgramHighlights: ProgramHighlight[] = [
  {
    icon: "graduation-cap",
    label: "CSEC Ready",
    description:
      "Strong foundation in core subjects preparing students for CSEC examinations.",
  },
  {
    icon: "users",
    label: "Small Class Sizes",
    description:
      "Better focus, participation, and teacher attention per student.",
  },
  {
    icon: "shield-check",
    label: "Safe Environment",
...
export const blcgyProgramQuickFacts: string[] = [
  "{{age}}",
  "Secure",
  "Qualified Teachers",
];
