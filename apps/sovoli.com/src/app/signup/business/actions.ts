...
const AIRTABLE_TABLE_ID = "tblh8v5OUOQgTaxnM"; // business-leads table
...
export async function submitBusinessLead(
  ...
  try {
    ...
    if (data.marketingMethods.length > 0) {
      fields["Marketing Methods"] = data.marketingMethods.join(", ");
    }
