	...
	return (
		...
		>
			...
			<div className="p-5">
				...
				<p className="mb-4 text-default-500 leading-relaxed">
					{industry.description}
				</p>

				{/* CTA */}
				<div className="flex items-center gap-2 font-semibold text-primary group-hover:text-primary-600 transition-colors">
					<span>Learn How</span>
