...
export const metadata: Metadata = {
	title: "Skills Training – Sovoli Business",
	description:
		"Show up in search, run targeted ads, and turn student interest into enrollment conversations.",
};

export default function SkillsTrainingLandingPage() {
	const meta = getBusinessCategoryMeta("skills-training");
				...
				<div className="mx-auto max-w-6xl px-4 py-12 sm:py-16 lg:px-12 lg:py-20">
					<div className="mx-auto max-w-3xl text-center">
						...
						<div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
							<Link
								href="/business/skills-training/growth-system"
