  ...
  answers: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: (
          <>
            Yes. Any designer you choose can update your pages and content
            through the Sovoli dashboard.
            <br />
            <br />
            Because the platform is open code, designers can also make deeper
            improvements as long as they are reviewed and approved by our team
            to keep everything secure and stable.
          </>
        ),
      },
      {
...
const beautyWellnessContent: GrowthSystemContent = {
  metadata: {
    ...
    description:
      "A complete digital visibility and lead system built for beauty and wellness businesses. Turn customer searches into booking conversations automatically.",
  },
  overview: {
    productName: "Growth System",
  ...
  features: {
    ...
    features: {
      discovery: {
        ...
        description:
          "A customer opens their phone and types 'beauty salon near me' or 'wellness services.' Your business appears at the top.",
        features: [
        ...
        screenshots: [
          ...
          },
          {
            image: googleResultImage,
            footnote:
              "Fully fleshed out Maps listing to show up for more customers.",
          },
          {
            image: sovoliDirectoryImage,
            footnote:
      ...
      ads: {
        ...
        headline: "Intelligent Advertising",
        description:
          "A customer nearby is scrolling through Facebook when they see your ad. We put even more potential customers in front of your business.",
        features: [
          "We run and manage Facebook + Instagram ads for you.",
      ...
      diagnostics: {
        ...
        headline: "Professional Website Built for Mobile",
        description:
          "Majority of customers are using mobile devices to search for beauty and wellness services, so we build a website that works perfectly on mobile.",
        features: [
          "Services page to showcase your offerings",
          "Comprehensive service details page",
          "Business Calendar to showcase your availability and specials",
  ...
  answers: {
    title: "Frequently Asked Questions",
    subtitle:
      "Everything you need to know about the Growth System and how it can help your beauty and wellness business grow.",
    faqs: [
      {
        question: "Can I test the system before committing to the full setup?",
        answer: (
          <>
            Yes. We can set up your website with a single service and run ads
            for that service so you can see how the lead-generation system works
            in real time.
            <br />
            <br />
            You only pay for the ad management and advertising budget during
      ...
      },
      {
        ...
        answer: (
          <>
            Yes. You fully own your domain and everything you publish—text,
            images, services, products, and branding.
            <br />
            <br />
            Sovoli provides the platform that powers the site, but your content
            and domain always remain yours and can be moved to another developer
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <br />
            The only thing that goes offline is your custom domain (e.g.,
            yourbusiness.com) and the Growth System engine—ads, funnels,
            analytics, and the automated customer-generation features.
            <br />
            <br />
            Your content is always yours and can be exported or rebuilt anywhere
      ...
      },
      {
        ...
        answer: (
          <>
            Setup is iterative. Once you send the content for your first
            service, we can publish an initial version and start generating
            value within <strong>5 hours</strong>.
            <br />
            <br />
            We continue improving the site as we receive more content—updating
  ...
  cta: {
    title: "Ready to Grow Your Beauty & Wellness Business?",
    description:
      "Get started today and start converting customer searches into booking conversations.",
    message:
      "I would like more information on your growth system for beauty and wellness businesses",
  },
  tracking: {
...
const fashionApparelContent: GrowthSystemContent = {
  metadata: {
    title: "Growth System for Fashion & Apparel – Sovoli",
    description:
      "A complete digital visibility and lead system built for fashion and apparel stores. Turn customer searches into sales conversations automatically.",
  },
  overview: {
    productName: "Growth System",
    businessType: "Fashion & Apparel Store",
    title: "Grow Your Fashion & Apparel Store With Digital Marketing Systems",
    description: (
      <>
        Sovoli is the only data-driven growth system built specifically for
        fashion and apparel stores in <strong>Guyana</strong> and{" "}
        <strong>Jamaica</strong>.
      </>
    ),
  },
  customers: {
    title: "Fashion & Apparel Stores Already Growing With Sovoli",
    customers: [],
  },
  features: {
    title: "Features",
    features: {
      discovery: {
        ...
        headline: "Customers are searching.",
        description:
          "A customer opens their phone and types 'clothing store near me' or 'fashion boutique.' Your store appears at the top.",
        features: [
          "Show up when customers search online",
          "Appear on Google and Bing maps",
          "Be listed in trusted business directories",
      ...
      ads: {
        ...
        headline: "Intelligent Advertising",
        description:
          "A customer nearby is scrolling through Facebook when they see your ad. We put even more potential customers in front of your store.",
        features: [
          "We run and manage Facebook + Instagram ads for you.",
          "Target the right customers in your local area automatically",
          "Ad performance reports (how much did you spend? how many leads did you get? how much did you earn?)",
      ...
      diagnostics: {
        ...
        headline: "Professional Website Built for Mobile",
        description:
          "Majority of customers are using mobile devices to search for fashion and clothing, so we build a website that works perfectly on mobile.",
        features: [
          "Product catalog page to showcase your clothing",
  ...
  answers: {
    title: "Frequently Asked Questions",
    subtitle:
      "Everything you need to know about the Growth System and how it can help your fashion and apparel store grow.",
    faqs: [
      {
        question: "Can I test the system before committing to the full setup?",
        answer: (
          <>
            Yes. We can set up your website with a single product category and
            run ads for that category so you can see how the lead-generation
      ...
      },
      {
        ...
        answer: (
          <>
            Yes. You fully own your domain and everything you publish—text,
            images, products, services, and branding.
            <br />
            <br />
            Sovoli provides the platform that powers the site, but your content
            and domain always remain yours and can be moved to another developer
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <br />
            The only thing that goes offline is your custom domain (e.g.,
            yourstore.com) and the Growth System engine—ads, funnels, analytics,
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            category, we can publish an initial version and start generating
            value within <strong>5 hours</strong>.
            <br />
            <br />
            We continue improving the site as we receive more content—updating
  ...
  cta: {
    title: "Ready to Grow Your Fashion & Apparel Store?",
    description:
      "Get started today and start converting customer searches into sales conversations.",
    message:
      "I would like more information on your growth system for fashion and apparel stores",
  },
  tracking: {
    content_name: "Growth System - Fashion & Apparel",
    content_type: "product",
    content_ids: ["growth-system", "fashion-apparel"],
    value: 80000,
    currency: "GYD",
    predicted_ltv: 1200000,
    audience: "business-owner",
...
const bookstoresContent: GrowthSystemContent = {
  metadata: {
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <br />
            The only thing that goes offline is your custom domain (e.g.,
            yourbookstore.com) and the Growth System engine—ads, funnels,
            analytics, and the automated customer-generation features.
            <br />
            <br />
            Your content is always yours and can be exported or rebuilt anywhere
  ...
  cta: {
    ...
    description:
      "Get started today and start converting customer searches into sales conversations.",
    message:
      "I would like more information on your growth system for bookstores",
  },
  tracking: {
...
const agricultureContent: GrowthSystemContent = {
  ...
  features: {
    ...
    features: {
      discovery: {
        ...
        headline: "Customers are searching.",
        description:
          "A customer opens their phone and types 'agricultural products near me' or 'farm supplies.' Your business appears at the top.",
        features: [
          "Show up when customers search online",
          "Appear on Google and Bing maps",
          "Be listed in trusted business directories",
      ...
      diagnostics: {
        ...
        headline: "Professional Website Built for Mobile",
        description:
          "Majority of customers are using mobile devices to search for agricultural products, so we build a website that works perfectly on mobile.",
        features: [
          "Product catalog page to showcase your products",
          "Comprehensive product details page",
          "Business Calendar to showcase your events and promotions",
          "AI Chatbot to answer customer questions",
          "Order and inquiry flows",
        ],
        nextFeature: "leadCapture",
  ...
  answers: {
    title: "Frequently Asked Questions",
    subtitle:
      "Everything you need to know about the Growth System and how it can help your agriculture business grow.",
    faqs: [
      {
        question: "Can I test the system before committing to the full setup?",
        answer: (
  ...
  cta: {
    title: "Ready to Grow Your Agriculture Business?",
    description:
      "Get started today and start converting customer searches into sales conversations.",
    message:
      "I would like more information on your growth system for agriculture businesses",
  },
  tracking: {
...
const hardwareContent: GrowthSystemContent = {
  metadata: {
    title: "Growth System for Hardware Stores – Sovoli",
    description:
      "A complete digital visibility and lead system built for hardware stores. Turn customer searches into sales conversations automatically.",
  },
  overview: {
    productName: "Growth System",
    businessType: "Hardware Store",
    title: "Grow Your Hardware Store With Digital Marketing Systems",
    description: (
      <>
        Sovoli is the only data-driven growth system built specifically for
        hardware stores in <strong>Guyana</strong> and <strong>Jamaica</strong>.
      </>
    ),
  },
  customers: {
    title: "Hardware Stores Already Growing With Sovoli",
    customers: [],
  },
  features: {
    title: "Features",
    features: {
      discovery: {
        ...
        headline: "Customers are searching.",
        description:
          "A customer opens their phone and types 'hardware store near me' or 'tools for sale.' Your store appears at the top.",
        features: [
          "Show up when customers search online",
          "Appear on Google and Bing maps",
          "Be listed in trusted business directories",
      ...
      diagnostics: {
        ...
        headline: "Professional Website Built for Mobile",
        description:
          "Majority of customers are using mobile devices to search for hardware and tools, so we build a website that works perfectly on mobile.",
        features: [
          "Product catalog page to showcase your products",
          "Comprehensive product details page",
          "Store Calendar to showcase your events and promotions",
  ...
  answers: {
    title: "Frequently Asked Questions",
    subtitle:
      "Everything you need to know about the Growth System and how it can help your hardware store grow.",
    faqs: [
      {
        question: "Can I test the system before committing to the full setup?",
        answer: (
  ...
  cta: {
    title: "Ready to Grow Your Hardware Store?",
    description:
      "Get started today and start converting customer searches into sales conversations.",
    message:
      "I would like more information on your growth system for hardware stores",
  },
  tracking: {
    content_name: "Growth System - Hardware",
    content_type: "product",
    content_ids: ["growth-system", "hardware"],
    value: 80000,
    currency: "GYD",
    predicted_ltv: 1200000,
    audience: "business-owner",
...
export const contentByCategory: Record<Category, GrowthSystemContent> = {
  ...
  "fashion-apparel": fashionApparelContent,
  bookstores: bookstoresContent,
