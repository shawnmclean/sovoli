...
export function ReserveForm({
  ...
  return (
    <div className="flex flex-col h-screen max-h-screen">
      ...
      <div className="text-center space-y-1 px-4 pt-6 shrink-0">
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-background px-4 pb-4 pt-2 border-t border-default-200 z-10 shrink-0">
        <Button
          as={WhatsAppLink}
