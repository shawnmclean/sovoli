...
export function Confirmation({
  ...
  return (
    <div className="space-y-8 text-center">
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
              ...
              <dd className="text-default-800">
                ...
                {formData.suppliesOther && (
                  <div className={selectedSuppliesItems.length > 0 ? "mt-2" : ""}>
      ...
      <Card className="rounded-2xl border border-default-200 bg-default-50/80 text-left">
        <CardHeader className="flex flex-col items-start gap-2 px-5 py-4 sm:px-6">
          <h3 className="text-lg font-semibold">Foundation & Contact</h3>
          <p className="text-small text-default-500">
            Information about the foundation and your point of contact.
          </p>
        </CardHeader>
        <Divider />
        <CardBody className="space-y-4 px-5 py-4 text-sm sm:px-6">
          ...
          {/* Placeholder for "Allow others" feature - to be implemented later */}
          <div className="flex flex-col gap-1">
            <dt className="font-medium text-default-600">Allow others</dt>
            <dd className="text-default-500 text-xs italic">
