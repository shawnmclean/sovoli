                ...
                {sortedInteractions.map((interaction, index) => {
                  ...
                  return (
                    <div key={index} className="relative pl-12">
                      {/* Timeline Node */}
                      <div
                        className={`absolute left-3 top-0 w-8 h-8 rounded-full flex items-center justify-center shadow-sm z-10 border-2 border-background ${
                          isLatest
                            ? colorClass
                      ...
                      <div className="flex flex-col gap-1.5 -mt-1">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            >
                              {interaction.contactOutcome === "not_reached"
                                ? "Did not reach"
                                : interaction.contactOutcome === "conversation"
                                  ? "Conversation"
                                  : "Brief Contact"}
                            </span>
                        ...
                        <div
                          className={`text-sm p-3 rounded-lg ${
                            isLatest
                              ...
                              : "bg-transparent text-default-500 pl-0 pt-1"
                          }`}
                        >
                          {interaction.notes ??
                            (interaction.blocker ? (
