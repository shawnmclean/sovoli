...
export function ProjectMetricsSection({
  ...
  // Construct the metrics route from the current pathname
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {metricsArray.map((metric, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-3 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow cursor-pointer"
              >
